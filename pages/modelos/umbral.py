    ...
    html.Div(className='page_box', children = [
        ...
        html.Div(className='div_grafica', children = [
            ...
            html.Div(className='grafica', children = [
                dcc.Loading(
                    type='dot',
                    children=dcc.Graph(id='figure_umbral',style={'width': '100%', 'height': '700px'})
                ),
            ])
    ]),
    ]),
...
def grafica_umbral(P0,t_i,t_f,r,t,mallado,size_vec,no_arrows):
